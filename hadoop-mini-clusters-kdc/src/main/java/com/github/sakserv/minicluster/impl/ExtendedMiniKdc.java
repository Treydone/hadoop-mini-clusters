...
public class ExtendedMiniKdc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final org.apache.hadoop.minikdc.MiniKdc miniKdc = new org.apache.hadoop.minikdc.MiniKdc(conf, workDir);
        miniKdc.start();
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.hadoop.minikdc.MiniKdc.class);
     ...
     */
    public ExtendedMiniKdc(Properties conf, File workDir) throws Exception {
    ...
    private void initKDCServer() throws Exception {
        ...
        kerberosConfig.setPrimaryRealm("ACME.ORG");
        kerberosConfig.setServicePrincipal("krbtgt/localhost@ACME.ORG");
